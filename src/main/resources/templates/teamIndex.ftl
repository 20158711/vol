    ...
    <aside id="sidebar">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu system_menus system_1 6">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('查看申请', '${request.contextPath}/seeReply');">查看申请</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('管理成员', '${request.contextPath}/seeNumber');">管理成员</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 0">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts-list"></i> 志愿组织</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('系统公告', '${request.contextPath}/seeNotice');">系统公告</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('团队公告', '${request.contextPath}/seeTeamNotice');">团队公告</a></li>
                </ul>
            </li>
